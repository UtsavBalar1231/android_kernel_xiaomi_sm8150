...
// scanno: Add function to check boottime and see if we can
// already use the motor
static bool drv8846_use_motor() {
...
void drv8846_move(struct drv8846_soc_ctrl *mctrl, uint8_t dir)
{
	...
	// scanno: Add check to see if we can use the motor
